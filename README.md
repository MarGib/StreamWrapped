...
The import detects Netflix date format from the CSV. Netflix exports commonly use `M/D/YY`; for example `5/18/26` means May 18, 2026. Ambiguous numeric dates fall back to Netflix's month-first convention when the file does not contain stronger evidence.
